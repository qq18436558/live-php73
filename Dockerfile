...
RUN apt update && DEBIAN_FRONTEND=noninteractive apt-get install -y wget tzdata && \
    ...
    apt -y install php7.3 php7.3-cli php7.3-bcmath php7.3-bz2 php7.3-dom php7.3-sqlite3 php7.3-xml php7.3-xmlrpc php7.3-xsl php7.3-common php7.3-curl php7.3-fpm php7.3-gd php7.3-intl php7.3-json php7.3-mbstring php7.3-mysql php7.3-opcache php7.3-redis php7.3-soap php7.3-zip && \
